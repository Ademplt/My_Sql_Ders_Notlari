...
inner join developer_dersler as B on A.ders_id=B.ders_id;
...
select B.ders_id , B.ders_ismi , B.ders_saati from developer_dersler as A  
right join qa_dersler as B
on A.ders_id= B.ders_id;
