...
select urun_isim,musteri_isim from nisan where exists (select urun_isim from mart as mart_tablo where mart.urun_isim=nisan.urun_isim);
    
/* SORU3: Her iki ayda ortak satilmayan ürünlerin URUN_ISIM'lerini ve   bu ürünleri
  NİSAN ayında satın alan MUSTERI_ISIM'lerini listeleyen bir sorgu yazınız. 
 -----------------------------------------------------------------------------*/
select urun_isim,musteri_isim from nisan as nisan_tablo where not exists
